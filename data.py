...
def save_data_to_csv(objetos, endpoint):
    ...
    def extract_dataBolsaF_municipio(objeto):
        ...
        return [nomeIBGE, dataReferencia, valor, quantidadeBeneficiados]
    ...
    dados = [extract_dataBolsaF_municipio(objeto) for objeto in objetos]
    ...
    save_to_csv_bolsaFamilia(dados, nome_arquivo)